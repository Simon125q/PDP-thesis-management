...
func main() {
	...
	server.MyS.Router.Group(func(r chi.Router) {
		...
		r.Get("/realized/autocompleteTitle", handlers.Make(handlers.HandleAutocompleteTitle))
		r.Get("/realized/autocompleteSpecialization", handlers.Make(handlers.HandleAutocompleteSpecialization))
		r.Get("/realized/autocompleteAllTitles", handlers.Make(handlers.HandleAutocompleteAllTitles))
...
func populateDatabase(db *sql.DB) error {
	...
	queries := []string{
        ...
        ('202311', 'Piotr', 'Wójcik', 'Informatyka', 'I stopień', 'Sztuczna Inteligencja', 'stacjonarne'),
        ('202312', 'Katarzyna', 'Pawlak', 'Telekomunikacja', 'II stopień', 'Sieci Komputerowe', 'niestacjonarne'),
        ('202313', 'Michał', 'Kaczmarek', 'Informatyka', 'II stopień', 'Bezpieczeństwo Informatyczne', 'stacjonarne'),
        ('202314', 'Agnieszka', 'Szymańska', 'Elektrotechnika', 'I stopień', 'Systemy Automatyki', 'stacjonarne'),
        ('202315', 'Bartosz', 'Kowalski', 'Inżynieria Elektroniki', 'II stopień', 'Mikroprocesory', 'niestacjonarne'),
        ('202316', 'Natalia', 'Nowicka', 'Informatyka', 'I stopień', 'Programowanie Aplikacji Mobilnych', 'stacjonarne'),
        ('202317', 'Sebastian', 'Wróbel', 'Inżynieria Elektroniki', 'II stopień', 'Komunikacja Bezprzewodowa', 'niestacjonarne'),
        ('202318', 'Martyna', 'Kwiatkowska', 'Informatyka', 'I stopień', 'Inżynieria Danych', 'stacjonarne'),
        ('202319', 'Kamil', 'Jankowski', 'Telekomunikacja', 'II stopień', 'Przetwarzanie Sygnałów', 'niestacjonarne'),
        ('202320', 'Zofia', 'Mazur', 'Informatyka', 'I stopień', 'Inżynieria Oprogramowania', 'stacjonarne'),
		('202301', 'Jan', 'Kowal', 'Informatyka', 'I stopień', 'Inżynieria Oprogramowania', 'stacjonarne'),
		('202302', 'Maria', 'Wiśniewska', 'Fizyka', 'II stopień', 'Mechanika Kwantowa', 'niestacjonarne'),
		('202303', 'Adam', 'Nowak', 'Matematyka', 'II stopień', 'Algebra', 'stacjonarne'),
		('202304', 'Ewa', 'Zielińska', 'Biologia', 'I stopień', 'Biologia Molekularna', 'stacjonarne'),
		('202305', 'Tomasz', 'Lewandowski', 'Mechanika', 'II stopień', 'Robotyka', 'niestacjonarne'),
		('202306', 'Joanna', 'Krawczyk', 'Ekonomia', 'I stopień', 'Finanse', 'stacjonarne'),
		('202307', 'Marek', 'Górski', 'Zarządzanie', 'II stopień', 'Marketing', 'niestacjonarne'),
		('202308', 'Anna', 'Lis', 'Chemia', 'I stopień', 'Chemia Analityczna', 'stacjonarne'),
		('202309', 'Karol', 'Pawlak', 'Elektrotechnika', 'II stopień', 'Energetyka', 'niestacjonarne'),
		('202310', 'Ewelina', 'Michalska', 'Inżynieria Środowiska', 'I stopień', 'Ochrona Środowiska', 'stacjonarne'),
        ('202321', 'Łukasz', 'Ostrowski', 'Informatyka', 'I stopień', 'Programowanie Gier', 'stacjonarne'),
        ('202322', 'Zuzanna', 'Pietrzyk', 'Telekomunikacja', 'II stopień', 'Systemy Mobilne', 'niestacjonarne'),
        ('202323', 'Wojciech', 'Mazurek', 'Inżynieria Elektroniki', 'I stopień', 'Elektronika Cyfrowa', 'stacjonarne'),
        ('202324', 'Aleksandra', 'Górska', 'Informatyka', 'II stopień', 'Chmura Obliczeniowa', 'stacjonarne'),
        ('202325', 'Jakub', 'Sikora', 'Telekomunikacja', 'I stopień', 'Komunikacja Satelitarna', 'niestacjonarne'),
        ('202321', 'Jakub', 'Sikora', 'Informatyka', 'II stopień', 'Sztuczna Inteligencja', 'stacjonarne'),
        ('202322', 'Marta', 'Kwiatkowska', 'Inżynieria Elektroniki', 'I stopień', 'Mikroelektronika', 'niestacjonarne'),
        ('202323', 'Tomasz', 'Nowakowski', 'Elektrotechnika', 'II stopień', 'Elektryczne Systemy Sterowania', 'stacjonarne'),
        ('202324', 'Kamil', 'Bąk', 'Telekomunikacja', 'I stopień', 'Sieci Komputerowe', 'niestacjonarne'),
        ('202325', 'Patryk', 'Zieliński', 'Informatyka', 'II stopień', 'Bezpieczeństwo Informatyczne', 'stacjonarne'),
        ('202326', 'Aleksandra', 'Sikorska', 'Inżynieria Elektroniki', 'II stopień', 'Systemy Wbudowane', 'niestacjonarne'),
        ('202327', 'Dominik', 'Majewski', 'Elektrotechnika', 'I stopień', 'Mikrosystemy', 'stacjonarne'),
        ('202328', 'Monika', 'Bąk', 'Informatyka', 'II stopień', 'Programowanie Aplikacji Webowych', 'niestacjonarne'),
        ('202329', 'Wojciech', 'Lis', 'Inżynieria Elektroniki', 'I stopień', 'Technologie Mikroprocesorowe', 'stacjonarne'),
        ('202330', 'Agnieszka', 'Chmiel', 'Informatyka', 'II stopień', 'Algorytmy i Struktury Danych', 'stacjonarne'),
        ('202331', 'Krzysztof', 'Kaczmarek', 'Inżynieria Elektroniki', 'II stopień', 'Projektowanie Układów Cyfrowych', 'niestacjonarne'),
        ('202332', 'Ewa', 'Górska', 'Telekomunikacja', 'I stopień', 'Przetwarzanie Sygnałów', 'stacjonarne'),
        ('202333', 'Szymon', 'Woźniak', 'Informatyka', 'II stopień', 'Inżynieria Danych', 'niestacjonarne'),
        ('202334', 'Zuzanna', 'Dąbrowska', 'Inżynieria Elektroniki', 'I stopień', 'Komunikacja Cyfrowa', 'stacjonarne'),
        ('202335', 'Adam', 'Mazur', 'Elektrotechnika', 'II stopień', 'Automatyka i Robotyka', 'stacjonarne'),
        ('202336', 'Julia', 'Kowalska', 'Informatyka', 'I stopień', 'Inżynieria Oprogramowania', 'niestacjonarne'),
        ('202326', 'Klaudia', 'Michałowska', 'Inżynieria Elektroniki', 'II stopień', 'Mikrosystemy Elektroniki', 'stacjonarne'),
        ('202327', 'Piotr', 'Szulc', 'Informatyka', 'I stopień', 'Rozwój Oprogramowania', 'stacjonarne'),
        ('202328', 'Katarzyna', 'Bąk', 'Telekomunikacja', 'II stopień', 'Optymalizacja Sieci', 'niestacjonarne'),
        ('202329', 'Marek', 'Walczak', 'Inżynieria Elektroniki', 'I stopień', 'Nanotechnologia', 'stacjonarne'),
        ('202327', 'Piotr', 'Kowalski', 'Informatyka', 'I stopień', 'Rozwój Oprogramowania', 'stacjonarne'),
        ('202328', 'Kamil', 'Ślimak', 'Telekomunikacja', 'II stopień', 'Optymalizacja Sieci', 'niestacjonarne'),
        ('202329', 'Mateusz', 'Gortat', 'Inżynieria Elektroniki', 'I stopień', 'Nanotechnologia', 'stacjonarne'),
        ('202330', 'Paulina', 'Kołodziej', 'Informatyka', 'I stopień', 'Technologie Internetowe', 'stacjonarne');`,
